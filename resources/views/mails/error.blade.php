...
<head>
    ...
    <title>Une erreur est survenuf</title>
    <!-- Fonts -->
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-center">
                        <svg height="300px" width="300px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-body">
                        <p class="card-text text-center">Une erreur est survenu lors de la transaction
                        </p>
                    </div>
                    <div class="card-footer">
                        <a href="https://cbace-cga.com/?v=6af424daa409" class="btn btn-outline-dark btn-block">Revenir à
                            l'accueil</a>
                    </div>
                </div>
            </div>
